...
.main { max-width: 680px; margin: 0 auto; padding: 32px 24px; display: flex; flex-direction: column; gap: 0; }
...
.info-field-value { font-size: 13px; color: var(--color-text); font-weight: 400; }
...
.action-item__arrow { color: var(--color-text-muted); font-size: 14px; }
...
<nav class="topnav">
    ...
    <div class="topnav__actions">
        ...
        <!-- Profile icon — active since we're on this page -->
