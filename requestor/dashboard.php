...
<main class="main">
    ...
    <div class="card">
        ...
        <ul class="request-list">
            ...
            <!-- Empty state (remove this when you have real data from DB) -->
            ...
            <!--
            ====================================================
            EXAMPLE ROW — duplicate and populate from PHP/DB
            ====================================================
            <li class="request-item">
                <div class="request-item__info">
                    <div class="request-item__title-row">
                        <span class="request-item__title">Title Here</span>
                        <span class="badge badge--pending">Pending Review</span>
                    </div>
                    <p class="request-item__desc">Short description of the request goes here.</p>
                    <div class="request-item__meta">
                        <span class="tag">Category</span>
                        <span class="badge badge--high">HIGH</span>
                        <span class="tag">Facebook, Youtube</span>
                    </div>
                </div>
